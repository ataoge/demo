...
namespace Ataoge.AspNetCore.Identity.Entities
{
		...
		where TUserClaim : IdentityUserClaim<TKey>
	{
        ...
        /// <summary>
		/// Initializes a new instance of <see cref="T:Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUser`1" />.
		/// </summary>
		public IdentityUser()
		{
    ...
    public class IdentityUser : IdentityUser<string>
    {
	 ...
	 public class IntIdentityUser : IdentityUser<int>
	 {
		 public IntIdentityUser()
		 {
		 }

		 public IntIdentityUser(string userName) 
		 {
			 UserName = userName;
		 }
	 }
